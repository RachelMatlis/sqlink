...
public:
	...
	const TIDb& getBuildingID() const;
...
template <class TIDb>
Building_t<TIDb>::Building_t(const Building_t& i_building)
{
	m_ID = i_building.m_ID;
}

template <class TIDb>
Building_t<TIDb>& Building_t<TIDb>::operator=(const Building_t& i_building)
{
	if (this != &i_building)
	{
		m_ID = i_building.m_ID;
...
template <class TIDb>
const TIDb& Building_t<TIDb>::getBuildingID() const
{
	return m_ID;
}